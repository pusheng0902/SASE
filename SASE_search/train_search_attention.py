...
from model_search_attention import Network
from architect import Architect


parser = argparse.ArgumentParser("cifar")
parser.add_argument('--data', type=str, default='/mnt/wanghm/', help='location of the data corpus')
...
args.save = 'experiments/{}-{}-{}'.format(args.model_name,args.save, time.strftime("%Y%m%d-%H%M%S"))
