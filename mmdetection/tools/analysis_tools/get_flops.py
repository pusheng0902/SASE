...
def inference(args, logger):
    ...
    # bug in mmengine, mmSyncBN requires a distributed environmenthis question involves models like configs/strong_baselines
    ...
    print('Number of parameters: {:<8}'.format(count_parameters_in_MB(model)))
    ...
    macs, params = get_model_complexity_info(model.backbone, (3, 800, 1333), as_strings=True, print_per_layer_stat=True, verbose=True)
